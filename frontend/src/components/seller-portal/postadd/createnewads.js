    ...
    */
    ...
    const handleImage = (e) => {
        ...
        for (let i = 0; i < length; i++) {
            /**
             * I learn `URL.createObjectURL` from the given link
             * [15] “How to upload image and preview it using reactjs ?,” GeeksforGeeks, https://www.geeksforgeeks.org/how-to-upload-image-and-preview-it-using-reactjs/ (accessed May 31, 2023). 
            */
