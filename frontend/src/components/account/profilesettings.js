...
function ProfileSettings() {
  ...
  const [authenticationApp2FAEnabled, setAuthenticationApp2FAEnabled] =
    useState(false);
  ...
  const updateSignUpData_General = async (e) => {
    ...
    if (phoneNumber !== null) {
      if (phoneNumber.trim().length !== 10 && phoneNumber.trim().length !== 0) {
        alert(
          "Make sure Phone number is 10 digits long.\nAlso ensure that only numbeers are entered! (no '-')"
        );
        return;
      }
    }

    await userSignUpUpdate(userID, {
      email: email,
    ...
    <div className="profileSettings">
      ...
      <div className="profileSettings-general">
        ...
        <form className="profileSettings-general-form">
          <li>
            {" "}
            Full Name: <input placeholder={fullName || ""} disabled />{" "}
          </li>
          <li>
            {" "}
            Email:{" "}
          ...
          <button id="updateButtons" onClick={updateSignUpData_General}>
            {" "}
            UPDATE GENERAL{" "}
          </button>
        </form>
      ...
      <div className="profileSettings-setPassword">
        ...
        <form className="profileSettings-setPassword-form">
          ...
          <button id="updateButtons" onClick={updateSignUpData_Password}>
            {" "}
            UPDATE PASSWORD{" "}
          </button>
        </form>
      ...
      <div className="profileSettings-twoFactorAuthentication">
        ...
        <form className="profileSettings-twoFactorAuthentication-form">
          <li>
            ...
            Email:{" "}
            <Switch
              className="profileSettings-toggle"
              onChange={handleEmailToggleSwitch}
          ...
          <li>
            ...
            <Switch
              className="profileSettings-toggle"
              onChange={handleAuthenticationAppToggleSwitch}
              checked={authenticationApp2FAEnabled}
              borderRadius={12}
            />{" "}
          </li>
        </form>
      ...
      <div className="profileSettings-setLocation">
        ...
        <form className="profileSettings-setLocation-form">
          <li>
            ...
            <Switch
              className="profileSettings-toggle"
              onChange={handleCurrentLocationToggleSwitch}
      ...
      <div className="profileSettings-danger">
        ...
        <form className="profileSettings-danger-form">
          <li>
            ...
            <Switch
              className="profileSettings-toggle"
              onChange={handleDisableAccountToggleSwitch}
